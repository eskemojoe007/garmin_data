...
# %%
tree = ET.parse('activity_2314497584.tcx')
root = tree.getroot()
...
ax.get_figure().savefig('2017_11_07_Figs\Speed_vs_distance.png',bbox_inches='tight')
ax = plot_dfs(dfs,'distance','bpm')
ax.set_ylabel('Heart Rate [BPM]')
ax.set_xlabel('Distance [m]')
ax.get_figure().savefig('2017_11_07_Figs\BPM_vs_distance.png',bbox_inches='tight')
ax = plot_dfs(dfs,'distance','cadence')
ax.set_ylabel('Cadence [Steps/min]')
ax.set_xlabel('Distance [m]')
ax.get_figure().savefig('2017_11_07_Figs\Cadence_vs_distance.png',bbox_inches='tight')
ax = plot_dfs(dfs,'time','distance',ls='none',marker='o')
ax.set_ylabel('Distance [m]')
ax.set_xlabel('Time [s]')
ax.legend()
ax.get_figure().savefig('2017_11_07_Figs\distance_vs_time.png',bbox_inches='tight')
ax = plot_dfs(dfs,'bpm','speed',ls='none',marker='o')
ax.set_ylabel('Speed [MPH]')
ax.set_xlabel('Heart Rate [BPM]')
# ax.set_ylim([10,20])
ax.legend()
ax.get_figure().savefig('2017_11_07_Figs\BPM_vs_Sp.png',bbox_inches='tight')
# end%%
...
ax.get_figure().savefig('2017_11_07_Figs\Times_bar.png',bbox_inches='tight')
# end%%
...
ax.get_figure().savefig('2017_11_07_Figs\Times_bar_normed.png',bbox_inches='tight')
# end%%
