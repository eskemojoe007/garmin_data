...
# %%
tree = ET.parse('activity_2150883025.tcx')
root = tree.getroot()
...
dfs[0] = dfs[0].loc[dfs[0].index > 3]

dfs[0]
dfs[0]['time'] = dfs[0]['time'] - dfs[0]['time'].iloc[0]
# ax.xaxis.set_major_formatter(FuncFormatter(timeTicks))
...
ax.get_figure().savefig('2017_10_20_Figs\Speed_vs_distance.png',bbox_inches='tight')
ax = plot_dfs(dfs,'distance','bpm')
ax.set_ylabel('Heart Rate [BPM]')
ax.set_xlabel('Distance [m]')
ax.get_figure().savefig('2017_10_20_Figs\BPM_vs_distance.png',bbox_inches='tight')
ax = plot_dfs(dfs,'distance','cadence')
ax.set_ylabel('Cadence [Steps/min]')
ax.set_xlabel('Distance [m]')
ax.get_figure().savefig('2017_10_20_Figs\Cadence_vs_distance.png',bbox_inches='tight')
ax = plot_dfs(dfs,'time','distance',ls='none',marker='o')
ax.set_ylabel('Distance [m]')
ax.set_xlabel('Time [s]')
ax.legend()
ax.get_figure().savefig('2017_10_20_Figs\distance_vs_time.png',bbox_inches='tight')
ax = plot_dfs(dfs,'bpm','speed',ls='none',marker='o')
ax.set_ylabel('Speed [MPH]')
ax.set_xlabel('Heart Rate [BPM]')
ax.set_ylim([10,20])
ax.legend()
ax.get_figure().savefig('2017_10_20_Figs\BPM_vs_Sp.png',bbox_inches='tight')
# end%%
...
ax.get_figure().savefig('2017_10_20_Figs\Times_bar.png',bbox_inches='tight')
# end%%
